...
#define DLP_POWER_ON_DELAY_TIME       1000/SYSTICK_PERIOD   //2s
...
#define PAD_POWER_ON_DELAY_TIME       2000/SYSTICK_PERIOD   //2s
...
#define X86_POWER_ON_DELAY_TIME       3000/SYSTICK_PERIOD   //1s
